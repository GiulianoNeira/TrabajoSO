...
int main() {
	...
	// Setear el numero de hilos para OpenMP
	...
	if (original.empty()) {
        	cout << "No se pudo abrir la imagen. Asegurate de que el archivo " << nombreOriginal << " existe en el directorio." << endl;
        	return -1;
	}
	...
	// Convertir la imagen original a escala de grises utilizando el metodo de luminosidad en paralelo con OpenMP
	...
	// Calcular la duracion de la conversion a escala de grises
	duration<double> tiempo_transcurrido = duration_cast<duration<double>>(end - start);
	cout << "Imagen creada con exito.\n";
	cout << "Tiempo de conversión a escala de grises con OpenMP: " << tiempo_transcurrido.count() << " segundos" << endl;
